...
- To calculate the expected cumulative reward (expected return), we discount distant rewards: the rewards that come sooner (at the beginning of the game) **are more probable to happen since they are more predictable than the long term future reward.**
